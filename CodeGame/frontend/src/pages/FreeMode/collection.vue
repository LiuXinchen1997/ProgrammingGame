  ...
  <el-col :span="6" v-for="(o, index) in data.slice((currentPage - 1) * pagesize, currentPage * pagesize)" :key="o" :offset="index % 3 === 0 ? 1 : 2" class="el-col">
    <el-card :body-style="{padding: '10px'}">
      ...
      <div style="padding: 14px;">
        <p class="fa fa-user-circle-o fa-1x">&nbsp;设计者&emsp;：{{o.username}}</p>
        <div class="bottom clearfix">
          ...
          {{o.like_num}}
          <el-button type="text" class="fa fa-trash fa-1x" @click="cancelCollectById(o.map_id, index)">删除</el-button>
...
export default{
  ...
  mounted () {
    ...
    const url = GetUrl('FreeMode/getAllCollectedMapByUsername')
    this.$axios({
      method: 'get',
      url: url,
      params: {
